            ...
            <div>
                <div className="list">
                    <div className="list-sortBox">
                        ...
                        <button className="list-sortBox-sale">판매량순</button>
                        <button className="list-sortBox-lowPrice">낮은 가격순</button>
                        <button className="list-sortBox-highPrice">높은 가격순</button>
                    </div>
