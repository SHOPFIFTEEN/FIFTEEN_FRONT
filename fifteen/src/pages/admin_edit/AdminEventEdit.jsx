                            ...
                            <div className='admin-info'>
                                <div className='admin_info_box'>
                                    <div className='admin-info-box-titleBox'>
                                        ...
                                        <div className='admin-info-box-titleBox-text'>{this.state.eventInfo.title}</div>
                                    </div>
                                    <div className='admin-info-box-subBox'>
                                        <div className='admin-info-box-subBox-date'>
                                            ...
                                            <div className='admin-info-box-subBox-text'>{this.state.eventInfo.start_date} ~ {this.state.eventInfo.end_date}</div>
                                        </div>
                                    </div>
...
export default withRouter(AdminEventEdit);
